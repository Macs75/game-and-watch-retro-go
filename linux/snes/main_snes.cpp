...
void S9xProcessEvents (bool8) {
    ...
    if (SDL_PollEvent(&event)) {
        if (event.type == SDL_KEYDOWN) {
            ...
            case SDLK_z:
                ...
                break;
            case SDLK_a:
                joystick1.values[ODROID_INPUT_X] = 1;
                break;
            case SDLK_s:
                joystick1.values[ODROID_INPUT_Y] = 1;
                break;				
            case SDLK_LSHIFT:
            ...
            case SDLK_z:
                ...
                break;
            case SDLK_a:
                joystick1.values[ODROID_INPUT_X] = 0;
                break;
            case SDLK_s:
                joystick1.values[ODROID_INPUT_Y] = 0;
                break;								
            case SDLK_LSHIFT:
	...
	S9xReportButton(ODROID_INPUT_X, joystick1.values[ODROID_INPUT_X]);
	S9xReportButton(ODROID_INPUT_Y, joystick1.values[ODROID_INPUT_Y]);
...
int main(int argc, char *argv[])
{
	...
	MAP_BUTTON(ODROID_INPUT_X, "Joypad1 B");
	MAP_BUTTON(ODROID_INPUT_Y, "Joypad1 X"); 
